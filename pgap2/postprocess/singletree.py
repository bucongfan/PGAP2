...
def main(indir: str, outdir: str, nodraw: bool, threads: int, disable: bool = False, also_pan: bool = False, core_thre: float = 0.95, step: int = 9, para_strategy: str = 'best', msa_method: str = 'mafft', tree_method: str = 'fasttree', add_paras: list = [], no_partition: bool = False):
    ...
    phy = Phylogeny(basic=basic, outdir=outdir, threads=threads, disable=disable,
                    ...
                    fastbaps_levels=None, fastbaps_prior=None, add_paras=add_paras, no_partition=no_partition)
